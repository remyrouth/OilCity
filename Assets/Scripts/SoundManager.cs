...
public class SoundManager : MonoBehaviour
{
    ...
    //     }
    //     public void ChangeVolume(float neValue) => audioSource.volume;
    ...
    /// single sound effect srcipt... which is for every building prefab or wahtever
    /// on awake, or on enable, subscribe to the settings manager (on volume change)
    /// and add itself to the list of sound manager
    /// NOTE : on disbale --> unsubsubscribe 
    /// make with virtual methods
}
